...
resource aws_iam_role "iam_for_eks" {
  ...
  tags = {
    yor_trace = "739e3fdb-099c-43c0-95fd-4289e98474ce"
...
resource aws_vpc "eks_vpc" {
  ...
  tags = {
    ...
    yor_trace            = "483ef6ba-16f7-4a5b-8cec-0aad05273ad2"
...
resource aws_subnet "eks_subnet1" {
  ...
  tags = {
    ...
    yor_trace                                       = "72acb50a-db8a-4c4d-b81b-a44c11455646"
    git_commit                                      = "68e454047fb4520f27ed75ffa066ee09d75e325b"
    git_file                                        = "terraform/aws/eks.tf"
    git_last_modified_at                            = "2020-06-16 14:46:24"
    git_last_modified_by                            = "nimrodkor@gmail.com"
...
resource aws_subnet "eks_subnet2" {
  ...
  tags = {
    ...
    "kubernetes.io/cluster/${local.eks_name.value}" = "shared"
    yor_trace                                       = "7a8f095a-f962-4b0c-bc24-6f70302fb92d"
    git_commit                                      = "68e454047fb4520f27ed75ffa066ee09d75e325b"
    git_file                                        = "terraform/aws/eks.tf"
    git_last_modified_at                            = "2020-06-16 14:46:24"
    git_last_modified_by                            = "nimrodkor@gmail.com"
...
resource aws_eks_cluster "eks_cluster" {
  ...
  tags = {
    yor_trace            = "7dd0366d-b443-40f0-9c19-7b78d590defa"
    git_commit           = "68e454047fb4520f27ed75ffa066ee09d75e325b"
    git_file             = "terraform/aws/eks.tf"
