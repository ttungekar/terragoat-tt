resource "azurerm_virtual_network" "example" {
  ...
  tags = {
    yor_trace = "f6d1a897-d1e7-4a46-a63a-3f804f8f609e"
    yor_name  = "example"
  }
}
...
resource "azurerm_network_interface" "ni_linux" {
  ...
  tags = {
    yor_trace            = "2962e42d-692b-4bdf-8388-ad1f211dfa8b"
...
resource "azurerm_network_interface" "ni_win" {
  ...
  tags = {
    yor_trace            = "54ad36d2-8847-46a0-8861-c8c4b48ff6b1"
    git_commit           = "68e454047fb4520f27ed75ffa066ee09d75e325b"
    git_file             = "terraform/azure/networking.tf"
    git_last_modified_at = "2021-05-02 10:06:10"
    git_last_modified_by = "nimrodkor@users.noreply.github.com"
...
resource azurerm_network_security_group "bad_sg" {
  ...
  tags = {
    yor_trace            = "2d5813cf-dcc8-4e76-a2df-396d559dffbb"
    git_commit           = "68e454047fb4520f27ed75ffa066ee09d75e325b"
    git_file             = "terraform/azure/networking.tf"
    git_last_modified_at = "2021-05-02 10:06:10"
    git_last_modified_by = "nimrodkor@users.noreply.github.com"
...
resource azurerm_network_watcher "network_watcher" {
  ...
  resource_group_name = azurerm_resource_group.example.name
  tags = {
    yor_trace            = "8f85b2b6-da09-463c-95a1-1b352806a2d6"
    git_commit           = "68e454047fb4520f27ed75ffa066ee09d75e325b"
    git_file             = "terraform/azure/networking.tf"
    git_last_modified_at = "2021-05-02 10:06:10"
    git_last_modified_by = "nimrodkor@users.noreply.github.com"
...
resource azurerm_network_watcher_flow_log "flow_log" {
  ...
  tags = {
    yor_trace            = "64ae8a01-872f-4940-b51a-46dd89809cd5"
    git_commit           = "68e454047fb4520f27ed75ffa066ee09d75e325b"
    git_file             = "terraform/azure/networking.tf"
