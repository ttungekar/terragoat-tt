resource "azurerm_virtual_network" "example" {
  ...
  tags = {
    yor_trace = "425ef46f-d550-4338-84e3-2f81599b089e"
  }
}
...
resource "azurerm_network_interface" "ni_linux" {
  ...
  tags = {
    yor_trace = "e97a9ca5-b03e-40fb-ba9b-b6318323c4b1"
  }
}
...
resource "azurerm_network_interface" "ni_win" {
  ...
  tags = {
    yor_trace = "07c33678-2dc2-471b-94cc-dbdcbbbf4f7b"
  }
}
...
resource azurerm_network_security_group "bad_sg" {
  ...
  tags = {
    yor_trace = "7d8dae17-bffc-4ffd-b036-58054e9cdfe9"
  }
}
...
resource azurerm_network_watcher "network_watcher" {
  ...
  resource_group_name = azurerm_resource_group.example.name
  tags = {
    yor_trace = "095a0502-d5a0-4655-ae5d-c5ecbf58fafe"
  }
}
...
resource azurerm_network_watcher_flow_log "flow_log" {
  ...
  tags = {
    yor_trace = "f1879001-8410-4f9c-a336-053d2ed90346"
  }
}